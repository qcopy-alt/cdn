@ECHO off
title RIP Tweaks - Private - Requesting Admin
MODE 50,6
color 9
echo.
echo.
echo          RIP Tweaks - Private - Requesting Admin
...
color 8
echo. 
echo     %ESC%[31mWelcome %USERNAME%, To RIP Tweaks V4.2 Private!
echo. 

goto warning

:warning
title RIP Tweaks - Private (Warning)
...
powershell -ExecutionPolicy Unrestricted -NoProfile Checkpoint-Computer -Description 'RIP Tweaks V4.2 Restore Point' 

:main

title RIP Tweaks Private V4.2
...
echo.       
echo.                                    
echo                                                 %ESC%I__________.__                               
echo                                                 %ESC%I\______   \__I_____    
echo                                                 %ESC%I I       _/  \____ \    
echo                                                 %ESC%I I    I   \  I  I_) )   
echo                                                 %ESC%I I____I_  /__I   __/   
echo                                                 %ESC%I        \/   I__I      
echo. 
echo.                                                   %ESC%[31mPrivate Edition
echo.
echo.
echo                                         %ESC%[90m The Best Private FPS Boost Service!
echo                                  %ESC%[90m10x More Performance With RIP Tweaks Paid Packs!
echo                                           %ESC%[90mGet One Today at riptweaks.com
echo.
echo.
...
echo.
echo.
echo                                   %ESC%[31m[%ESC%[37m 1 %ESC%[31m]%ESC%[37m Discord Server       %ESC%[31m[%ESC%[37m 2 %ESC%[31m]%ESC%[37m Website               
echo.                                  %ESC%[90mJoin Our Discord Server    %ESC%[90mCheck Out Our Website 
echo.                                  %ESC%[90mdiscord.gg/riptweaks       %ESC%[90mriptweaks.com  
echo. 
echo.                                           %ESC%[31m[%ESC%[37m 3 %ESC%[31m]%ESC%[37m YouTube
echo.                                           %ESC%[90mSubscribe to Our YouTube Channel
echo.                                           %ESC%[90myoutube.com/@riptweakss
echo.
echo.
echo                                                   %ESC%[31m[%ESC%[37m 4 %ESC%[31m]%ESC%[31m Main Menu
echo.
